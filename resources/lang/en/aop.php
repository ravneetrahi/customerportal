...
return [
  ...
  "change_password" => 'Change password',
	...
	"notes_files" => "Files",
	"notes_add_file"=> "Add file",
	"notes_date_created"=> "Date Created",
	

	"case_sap" => "SAP Release",
	"case_cua" => "Use CUA ",
	"case_unicode" => "Unicode System ",
	"date_time"=>"Date/Time Opened",
	...
	"case_status" => "Status",
	"case_type" => "Type",
	"case_system_type" => "System Type",
	"case_products" => "Products",
